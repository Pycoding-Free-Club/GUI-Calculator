...
def delete():
    global label
    label.config(text=label.cget("text")[0:-1])
...
place_btn(False, 0, 672, "AC", command=clean)
place_btn(True, 250, 672, "Delete", command=delete)
place_btn(True, 375, 672, "Save", command=save)
